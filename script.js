...
(function () {
  rod = localStorage.getItem(playerName);
  maxScore = localStorage.getItem(playerScore);
...
function storeWin(rod, score) {
  if (score > maxScore) {
    maxScore = score;
    localStorage.setItem(playerName, rod);
    localStorage.setItem(playerScore, maxScore);
  }
